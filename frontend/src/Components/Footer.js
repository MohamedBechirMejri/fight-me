      ...
      >
        <div class="">
          <div class="max-w-6xl m-auto   flex flex-wrap justify-center">
            <div class="p-5 w-48 ">
              <div class="text-xs uppercase   font-medium">Home</div>
            ...
            <div class="p-5 w-48 ">
              <div class="text-xs uppercase   font-medium">User</div>
              <a class="my-3 block" href="/#">
              ...
              <a class="my-3 block" href="/#">
                Career{" "}
                <span class="text-teal-600 text-xs p-1">We're hiring</span>
              </a>
              <a class="my-3 block" href="/#">
            ...
            <div class="p-5 w-48 ">
              <div class="text-xs uppercase   font-medium">Resources</div>
              <a class="my-3 block" href="/#">
        ...
        <div class="  pt-2 ">
          <div
            class="flex pb-5 px-3 m-auto pt-5 border-t   text-sm flex-col
          ...
          >
            ...
            <div class="md:flex-auto md:flex-row-reverse mt-2 flex-row flex">
              <a href="/#" class="w-6 mx-1">
                <svg
                  class="fill-current cursor-pointer  hover:text-gray-400"
                  width="100%"
                  height="100%"
                  viewBox="0 0 24 24"
                  version="1.1"
